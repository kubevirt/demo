...
```bash
$ kubectl apply -f https://github.com/kubevirt/kubevirt/releases/download/v0.19.0-rc.0/kubevirt-operator.yaml
…
deployment.apps/virt-operator created

$ kubectl apply -f https://github.com/kubevirt/kubevirt/releases/download/v0.19.0-rc.0/kubevirt-cr.yaml
...
```bash
$ curl -L -o virtctl https://github.com/kubevirt/kubevirt/releases/download/v0.19.0-rc.0/virtctl-v0.19.0-rc.0-linux-amd64
$ chmod +x virtctl
```
